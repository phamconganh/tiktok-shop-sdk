...
})(AnalyticsV202405ApiApiKeys = exports.AnalyticsV202405ApiApiKeys || (exports.AnalyticsV202405ApiApiKeys = {}));
class AnalyticsV202405Api {
     ...
     */
    async ShopPerformanceGet(startDateGe, endDateLt, shopCipher, xTtsAccessToken, contentType, withComparison, granularity, currency, options = { headers: {} }) {
     ...
     */
    async ShopProductsPerformanceGet(startDateGe, endDateLt, shopCipher, xTtsAccessToken, contentType, pageSize, sortField, sortOrder, currency, pageToken, options = { headers: {} }) {
     ...
     * @param currency Currency. Available values: USD, LOCAL Default value: LOCAL * USD: US dollars * LOCAL: local currency where the shop is located
     */
    async ShopProductsProductIdPerformanceGet(productId, startDateGe, endDateLt, shopCipher, xTtsAccessToken, contentType, withComparison, granularity, currency, options = { headers: {} }) {
...
//# sourceMappingURL=analyticsV202405Api.js.map