...
class CustomerServiceV202309Api {
     ...
     * @param shopCipher
     */
    async AgentsSettingsGet(xTtsAccessToken, contentType, shopCipher, options = { headers: {} }) {
     ...
     */
    async AgentsSettingsPut(xTtsAccessToken, contentType, shopCipher, UpdateAgentSettingsRequestBody, options = { headers: {} }) {
        const localVarPath = this.basePath + '/customer_service/202309/agents/settings';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param shopCipher
     */
    async ConversationsConversationIdMessagesGet(conversationId, pageSize, xTtsAccessToken, contentType, pageToken, locale, sortOrder, sortField, shopCipher, options = { headers: {} }) {
     ...
     */
    async ConversationsConversationIdMessagesPost(conversationId, xTtsAccessToken, contentType, shopCipher, SendMessageRequestBody, options = { headers: {} }) {
        const localVarPath = this.basePath + '/customer_service/202309/conversations/{conversation_id}/messages'
            .replace('{' + 'conversation_id' + '}', encodeURIComponent(String(conversationId)));
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
     ...
     * @param shopCipher
     */
    async ConversationsConversationIdMessagesReadPost(conversationId, xTtsAccessToken, contentType, shopCipher, options = { headers: {} }) {
     ...
     * @param shopCipher
     */
    async ConversationsGet(pageSize, xTtsAccessToken, contentType, pageToken, locale, shopCipher, options = { headers: {} }) {
     ...
     */
    async ConversationsPost(xTtsAccessToken, contentType, shopCipher, CreateConversationRequestBody, options = { headers: {} }) {
        const localVarPath = this.basePath + '/customer_service/202309/conversations';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/json'];
...
//# sourceMappingURL=customerServiceV202309Api.js.map